export async function fetchUrl(url: string, method: string, bodyObject?: any, tokenAccess?: string) {
    const myHeaders = getHTTPHeader(getCookie("csrftoken"), tokenAccess);
